...
<!-- INICIO BANNER -->
  <div class=""><img src="img/topo-fale.png"></img></div>
  <!-- FIM BANNER -->
...
<div class="row">
  <div class="small-12 medium-12 large-6 columns">
    <h5 class="txt-contato">Utilize o formulário abaixo para enviar sua mensagem.<br>
      Preencha os campos corretamente, inserindo seu nome, e-mail, telefone, assunto e mensagem.</h5>
  ...
  <div class="small-12 medium-12 large-6 columns hide-for-small-only">
    <div class="txt-contato">Rua José Antonio Fontes, 378-A /Vila Tolstoi<br>
      São Paulo -SP<br>
      Cep:03255-000</div>
    <h5 class="txt-contato">Telefones</h5>
    <div class="txt-contato"><i class="fas fa-mobile-alt"></i>&nbsp;11 3794-2016<br><i class="fa fa-whatsapp"></i>&nbsp;11 9.7787-6106 </div>
    <br><br><br>
