...
<html class="no-js" lang="pt-br" >
  <head>
    ...
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.2/css/all.css" integrity="sha384-fnmOCqbTlWIlj8LyTjo7mOUStjsKC4pOpQbqyi7RrhN7udi9RwhKkMHpvLbHG9Sr" crossorigin="anonymous">
      ...
      <!-- menu -->
      <!-- CODIGO TOP -->
      <link rel="stylesheet" href="css/style-top.css"> <!-- Gem style -->
...
<div class="themis hide-for-small"><a href="https://suporte.aurum.com.br/hc/pt-br" target="_blank"><img src="img/logocliente.png"></img></a></div>
...
<!-- INICIO BANNER -->
  <div class=""><img src="img/topo-adv.png"></img></div>
...
<div class="row">
<br>
<div class="large-4 columns"><img src="img/pic-adv.png"></img></div>
<div class="large-4 columns">
  <div class="txt-vitae">
    Fundado em 2008, o escritório, R. A. SILVA ADVOCACIA & CONSULTORIA, foi criado com o objetivo de propiciar a entrega da excelência técnica aos seus clientes. O responsável pela área jurídica é o advogado, RONALDO ANTONIO DA SILVA, formado em Direito pela Faculdade de Direito de São Bernardo do Campo - FDSBC (www.direitosbc.br). Anteriormente, no ano de 1999, também, formou-se em Administração de Empresas pelo Centro Universitário Ibero-Americano - UNIBERO (www.unibero.edu.br).
  </div>
</div>
<div class="large-4 columns">Grafico igual do site https://www.oliveiranevesadvocacia.com.br/sobre-oliveira-neves.php</div>
