...
add_image_size( 'news', 360, 251, true );
...
function sf_load_scripts(){
	...
	wp_enqueue_style( 'top', get_template_directory_uri() . '/css/cd-top.css', array(), null, 'all');
...
function parea_sidebars(){
	...
	register_sidebar(
		array(
			'name'			=> __( 'Conteudo Estrutura' , 'parea' ),
			'id'			=> 'content-home',
			'description'	=> __( 'Inclua texto que aparece na home na parte de estrutura' , 'parea' ),
			'before_widget'	=> '',
			'after_widget'	=> '',
			'before_title'	=> '',
			'after_title'	=> '',			
	...
	register_sidebar(
		array(
			'name'			=> __( 'Imagem Estrutura' , 'parea' ),
			'id'			=> 'img-home',
			'description'	=> __( 'Inclua a imagem que aparece na home na parte de estrutura' , 'parea' ),
			'before_widget'	=> '',
			'after_widget'	=> '',
			'before_title'	=> '',
			'after_title'	=> '',			
	...
	register_sidebar(
		array(
			'name'			=> __( 'Footer Funcionamento' , 'parea' ),
			'id'			=> 'footer-funcionamento',
			'description'	=> __( 'Inclua informaçoes de funcionamento do rodape' , 'parea' ),
			'before_widget'	=> '',
			'after_widget'	=> '',
			'before_title'	=> '',
			'after_title'	=> '',			
